...
values ( 'z tobą zawsze!!!', (SELECT id from USERS WHERE id=1), (SELECT id from POST WHERE id=1) );
insert into Comment ( CONTENT, USER_ID, POST_ID )
values ( 'jestem za', (SELECT id from USERS WHERE id=3), (SELECT id from POST WHERE id=2) );
insert into Comment ( CONTENT, USER_ID, POST_ID )
values ( 'z tobą!!!', (SELECT id from USERS WHERE id=1), (SELECT id from POST WHERE id=2) );
insert into Comment ( CONTENT, USER_ID, POST_ID )
values ( 'jasne', (SELECT id from USERS WHERE id=3), (SELECT id from POST WHERE id=1) );
